...
[2023 KAKAO BLIND RECRUITMENT 문제링크](https://school.programmers.co.kr/learn/courses/30/lessons/150370)
...
- 1 ≤ `terms`의 길이 ≤ 20
  ...
  - 약관 종류는 `A`~`Z`중 알파벳 대문자 하나이며, `terms` 배열에서 약관 종류는 중복되지 않습니다.
